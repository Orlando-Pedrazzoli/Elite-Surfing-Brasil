            ...
            <div className='blog-manager__item' key={post._id}>
              <div className='blog-manager__item-info'>
                <div className='blog-manager__item-badges'>
                  <span
                    className={`blog-manager__badge ${post.published ? 'blog-manager__badge--pub' : 'blog-manager__badge--draft'}`}
                  >
                    {post.published ? 'Publicado' : 'Rascunho'}
                  </span>
                  {post.featured && (
                    <span className='blog-manager__badge blog-manager__badge--feat'>
                      ⭐ Destaque
                    </span>
                  )}
              ...
              <div className='blog-manager__item-actions'>
                ...
                <button onClick={() => handleDelete(post._id)} title='Apagar'>
                  🗑️
                </button>
              </div>
            </div>
